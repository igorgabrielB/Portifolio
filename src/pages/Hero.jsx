...
export default function Hero({ onCTAClick }) {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden pt-20 flex items-center justify-center px-4 hero-background">
      ...
      <div className="absolute top-10 left-8 w-72 h-72 bg-primary-600/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse"></div>
      <div className="absolute bottom-10 right-8 w-72 h-72 bg-primary-700/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="absolute left-1/2 top-1/4 w-px h-80 hero-line"></div>
      <div className="absolute right-1/4 top-2/3 w-px h-64 hero-line opacity-70"></div>
      <div className="absolute left-10 top-1/2 w-24 h-24 rounded-full border border-primary-500/40 blur-xl"></div>
      <div className="absolute right-20 bottom-32 w-32 h-32 rounded-full border border-primary-400/30 blur-2xl"></div>
